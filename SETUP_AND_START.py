...
# ========== TWITCH ==========
# Replace this with your Twitch username. You can ignore this if you stream on YouTube.
TWITCH_CHANNEL = 'YOUR_TWITCH_NAME_HERE'

# ========== YOUTUBE ==========
# Replace this with your YouTube's Channel ID. You can ignore this if you stream on Twitch.
...
# ========== LETS GO (don't change this) ==========
from TwitchPlays.Core import Core
try:
    Core(
        STREAMING_ON_TWITCH,
        TWITCH_CHANNEL,
